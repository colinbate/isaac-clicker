...
<div class="overflow-hidden rounded-lg bg-white dark:bg-gray-900 shadow text-left">
  <div class="grid grid-cols-1 md:grid-cols-5 gap-4 px-4 py-5 sm:p-6 h-[36rem]">
    ...
    <div class="md:col-span-3 flex flex-col flex-1 overflow-y-auto">
      <Board on:click={doClick} />
    </div>
    <div class="md:col-span-2 flex flex-col flex-1 overflow-y-auto">
      <Store {store}/>
    </div>
  </div>
</div>